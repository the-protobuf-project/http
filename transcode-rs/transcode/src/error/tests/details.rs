...
use super::DOMAIN;
use crate::error::{Code, DebugInfo, Detail, Error, ErrorInfo, ResourceInfo, format_duration};
...
fn a_supplied_error_info_is_not_duplicated() {
    let err = Error::new(Code::NotFound, "gone")
...
fn debug_info_is_stripped() {
    let err = Error::new(Code::Internal, "boom")
