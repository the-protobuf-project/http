...
// negotiate_test.go covers content negotiation, which is where a transcoder most
...
func TestUnsatisfiableAcceptIsNotAcceptable(t *testing.T) {
	// The transcoder does not fall back to a codec the client excluded: answering
