...
// adapter being an http.Handler makes that free, and nothing here duplicates
// it.
//
...
// retry. There it is a client interceptor, and retrying at the adapter would be
// wrong — the adapter cannot know whether a method is idempotent, and replaying
