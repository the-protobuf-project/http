...
// recovery.go records a panic that the adapter caught.
...
//
// The catching itself happens in the adapter, which is the only thing that owns
...
// observability stack as everything else, rather than only in the adapter's own
// logger.
